...
<body class="login-page" style="background-color: #a84e68">
    ...
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">Smart Queue</a>
            <small>Appointment Management</small>
        </div>
        <div class="card">
            <div class="body">
               <form:form id="AloginForm" method="post" action="../adminlogin.do" modelAttribute="AloginBean">
                    <div class="msg">Administration Login</div>
                    ...
                    <div class="row m-t-15 m-b--20">
                        <div class="col-xs-12">
                            <a href="../login.do">Login as hospital staff</a>
                        </div>
                    </div>
            </form:form>
            </div>
