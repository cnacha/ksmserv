                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right tab-col-lime" role="tablist">
                                <li role="presentation" class="active"><a href="#index" data-toggle="tab">Clinic</a></li>
                            </ul>
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div style="padding-left: 3%">
                                    ...
                                    <div class="form-group" >
                                        <div class="form-line">
                                            <input type="text" id="specialty" name="specialty" required="required" class="form-control" placeholder="Speciality" />
                                        </div>
                                    </div>
                                    <div class="form-group" >
                                        <div class="form-line">
                                            <input type="text" id="location" name="location" required="required" class="form-control" placeholder="Location" />
                                        </div>
                                    </div>
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div style="padding-left: 3%">
                                     <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="name-edit" name="name-edit" required="required" class="form-control" placeholder="Name" />
                                        </div>
                                    </div>
                                    <div class="form-group" >
                                        <div class="form-line">
                                            <input type="text" id="specialty-edit" name="specialty-edit" required="required" class="form-control" placeholder="Speciality" />
                                        </div>
                                    </div>
                                    <div class="form-group" >
                                        <div class="form-line">
                                            <input type="text" id="location-edit" name="location-edit" required="required" class="form-control" placeholder="Location" />
                                        </div>
                                    </div>
					...
					success : function(data) {
						...
						for (var i = 0; i < data.length; i++) {
							...
							html += "<td>"
									...
									+ data[i].location
									+ "</td>"
									+ "<td style=\"width: 8%\"> <a data-toggle=\"modal\" data-todo='{\"key\":\"" + data[i].keyString + "\",\"name\":\"" + data[i].name + "\",\"specialty\":\"" + data[i].specialty + "\",\"location\":\"" + data[i].location + "\"}'  class=\"open-edit btn btn-default btn-sm btn-block\" href=\"#edit\" >Edit</a> </td>"
