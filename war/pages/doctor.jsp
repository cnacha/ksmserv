					...
					success : function(data) {
						...
						for (var i = 0; i < data.length; i++) {
							...
							html += "<td>"
									...
									+ "<td style=\"width:8%\"><div class=\"row clearfix js-sweetalert\"><button class=\"btn bg-red waves-effect\" onclick=\"onclickRemoveDoctor('"+ data[i].keyString +"')\">Delete</button></div></td>";
							html += "</tr>";
						}
						html += "</tbody>";
						//html += "</table>";
