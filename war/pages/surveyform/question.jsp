                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right tab-col-lime" role="tablist">
                                <li role="presentation" class="active"><a href="#index" data-toggle="tab">Questions</a></li>
                            </ul>
...
<form:form  id="loginForm" method="post" action="../login.do" modelAttribute="loginBean">
                            ...
                            <form>
                                ...
                                <div style="padding-left: 3%">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="questionString" name="questionString" required="required" class="form-control" placeholder="Question" />
                                        </div>
                                    </div>
                                    <div class="form-group" >
                                        <div class="form-line">
                                            <input type="text" id="orderNo" name="orderNo" required="required" class="form-control" placeholder="orderNo" />
                                        </div>
                                    </div>
                        ...
                        <div class="modal-body">
                            <form>
                                <input type="hidden" id="key-edit" name="key-edit">
                                 <input type="hidden" id="formKey-edit" value="${formkey}">
                                <div style="padding-left: 3%">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="questionString-edit" name="questionString-edit" required="required" class="form-control" placeholder="Question" />
                                        </div>
                                    </div>
                                    <div class="form-group" >
                                        <div class="form-line">
                                            <input type="number" id="orderNo-edit" name="orderNo-edit" required="required" class="form-control" placeholder="orderNo" />
                                        </div>
                                    </div>
   ...
   <!--  <script src="../../plugins/bootstrap-select/js/bootstrap-select.js"></script> -->
    ...
    $(document).on("click", ".open-edit", function () {
		...
		var questionString = $(this).data('todo').questionString;
		var orderNo = $(this).data('todo').orderNo;
		
		$("#key-edit").val(key);
		$("#questionString-edit").val(questionString);
		$("#orderNo-edit").val(orderNo);
	...
	function list() {
		...
		$
				.ajax({
					url : "../listQuestionByFormWS.do?key=${formkey}",
					type : "GET",
					success : function(data) {
						...
						for (var i = 0; i < data.length; i++) {
							...
							html += "<td>"
									...
									+ "</td>"
									+"<td>"
									+ data[i].questionString
									+ "</td>"
									+ "<td style=\"width: 8%\"> <a data-toggle=\"modal\" data-todo='{\"key\":\"" + data[i].keyString + "\",\"questionString\":\"" + data[i].questionString + "\",\"orderNo\":\"" + data[i].orderNo + "\"}'  class=\"open-edit btn btn-default btn-sm btn-block\" href=\"#edit\" >Edit</a> </td>"
									...
									+ "<td style=\"width:8%\"><div class=\"row clearfix js-sweetalert\"><a  class=\"open-edit btn btn-default btn-sm btn-block\" href=\"choice.do?qkey="+ data[i].keyString +"\">Choice</a></div></td>";							
								html += "</tr>";
						}
						html += "</tbody>";
						//html += "</table>";
	...
	function create() {
		$("#loader").show();
		var obj = {
				questionString : $('#questionString').val(),
				orderNo : $('#orderNo').val(),
				type : $('#type').val(),
				formKey : $('#formKey').val()
		};
	...
	function update() {
		...
		var obj = {
				...
				questionString : $('#questionString-edit').val(),
				orderNo : $('#orderNo-edit').val(),
				type : $('#type-edit').val(),
				formKey : $('#formKey-edit').val()
	...
	//	alert("removing key");
		$("#loader").show();
		$.ajax({
			url : "../deleteQuestionWS.do?key="+key,
			type : "DELETE",
			dataType : "JSON",
			contentType : "application/json",
			mimeType : "application/json",
