	...
	<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    Survey Form - <a href="../question.do?formkey=${formKey}">Question</a> : ${questionString}
                </h2>
            </div>
            <!-- Basic Examples -->
                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right tab-col-lime" role="tablist">
                                <li role="presentation" class="active"><a href="#index" data-toggle="tab">Choice</a></li>
                            </ul>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="index">
                                    <button class="btn btn-info pull-right" data-toggle="modal" data-target="#add">
                                        <i class="material-icons">add</i> New Choice
                                    </button><br /><br /><br />
...
<form:form  id="loginForm" method="post" action="../login.do" modelAttribute="loginBean">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <input type="hidden" id="questionKey" value="${questionKey}">
                                <div style="padding-left: 3%">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="answerString" name="answerString" required="required" class="form-control" placeholder="Answer" />
                                        </div>
                                    </div>
                                    <div class="form-group" >
                                        <div class="form-line">
                        ...
                        <div class="modal-body">
                            <form>
                                <input type="hidden" id="key-edit" name="key-edit">
                                 <input type="hidden" id="questionKey-edit" value="${questionKey}">
                                <div style="padding-left: 3%">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="answerString-edit" name="answerString-edit" required="required" class="form-control" placeholder="Answer" />
                                        </div>
                                    </div>
                                    <div class="form-group" >
                                        <div class="form-line">
   ...
   <!--  <script src="../../plugins/bootstrap-select/js/bootstrap-select.js"></script> -->
    ...
    $(document).on("click", ".open-edit", function () {
		...
		var answerString = $(this).data('todo').answerString;
		var orderNo = $(this).data('todo').orderNo;
		
		$("#key-edit").val(key);
		$("#answerString-edit").val(answerString);
	...
	function list() {
		...
		$
				.ajax({
					url : "../listChoiceByQuestionWS.do?key=${questionKey}",
					type : "GET",
					success : function(data) {
						...
						for (var i = 0; i < data.length; i++) {
							...
							html += "<td>"
									...
									+ data[i].answerString
									+ "</td>"
									+ "<td style=\"width: 8%\"> <a data-toggle=\"modal\" data-todo='{\"key\":\"" + data[i].keyString + "\",\"answerString\":\"" + data[i].answerString + "\",\"orderNo\":\"" + data[i].orderNo + "\"}'  class=\"open-edit btn btn-default btn-sm btn-block\" href=\"#edit\" >Edit</a> </td>"
	...
	function update() {
		...
		var obj = {
				...
				answerString : $('#answerString-edit').val(),
				orderNo : $('#orderNo-edit').val(),
				questionKey : $('#questionKey-edit').val()
